...
| `bridge_mode` | `"SIMULAZIONE"` | `SIMULAZIONE`/`COLLAUDO`/`REALE` | Modalità **nominata** (#311 §3.1), derivata e coerente con `dry_run` (che resta autoritativo: incoerenza → Simulazione). `COLLAUDO` scrive il CSV col banner «XTrader in simulazione». |
