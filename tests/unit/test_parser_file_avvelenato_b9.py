...
VELENI = {
    ...
    # `sys.getrecursionlimit()` (default 1000). Col limite alzato quei livelli non sono più
    # patologici e il veleno smette di essere veleno. Ora arriva dalla fonte unica, ed è
    # relativa all'interprete che sta girando.
