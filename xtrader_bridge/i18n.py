...
_CATALOG = {
    "EN": {
        ...
        "Catalogo Betfair:": "Betfair catalog:",
        ...
        "Dizionario mercati": "Markets dictionary",
        "Traduce i nomi squadra così come li scrive il canale nel nome atteso da Betfair. Seleziona i profili nel Parser Personalizzato.": "Translates team names as the channel writes them into the name expected by Betfair. Select the profiles in the Custom Parser.",
        ...
        "Profilo:": "Profile:",
        "(clicca un profilo per aprirlo)": "(click a profile to open it)",
        "🧩 {n}": "🧩 {n}",
        "· {n} righe": "· {n} rows",
        "⚠ {name} (solo riferito)": "⚠ {name} (referenced only)",
        "✏️ Rinomina": "✏️ Rename",
        ...
        "⚠️ «{name}» è ancora selezionato in {count} parser ({names}): dopo l'eliminazione quei segnali verranno scartati (MAPPING_MISSING) finché non togli il profilo da quei parser.": "⚠️ «{name}» is still selected in {count} parsers ({names}): after deletion those signals will be discarded (MAPPING_MISSING) until you remove the profile from those parsers.",
        "⚠️ «{name}» è ancora selezionato in {count} parser ({names}): dopo l'eliminazione quei segnali verranno scartati (MARKET_MAPPING_MISSING) finché non togli il profilo da quei parser.": "⚠️ «{name}» is still selected in {count} parsers ({names}): after deletion those signals will be discarded (MARKET_MAPPING_MISSING) until you remove the profile from those parsers.",
        ...
        # Fail-fast P3-5 #76: save fallito a START → sessione solo in-memory vietata.
        "❌ Salvataggio config FALLITO: avvio annullato (al riavvio la pulizia del CSV userebbe la config vecchia su disco). Correggi l'errore segnalato sopra e riprova.": "❌ Config save FAILED: start cancelled (on restart the CSV cleanup would use the old config on disk). Fix the error reported above and try again.",
        ...
        "Griglia regole — 14 colonne CSV": "Rules grid — 14 CSV columns",
        "Selezione:": "Selection:",
    ...
    "ES": {
        ...
        "Catalogo Betfair:": "Catálogo Betfair:",
        "➕ Provider": "➕ Proveedor",
        ...
        "Dizionario mercati": "Diccionario de mercados",
        "Traduce i nomi squadra così come li scrive il canale nel nome atteso da Betfair. Seleziona i profili nel Parser Personalizzato.": "Traduce los nombres de equipo tal como los escribe el canal al nombre esperado por Betfair. Selecciona los perfiles en el Parser Personalizado.",
        ...
        "Profilo:": "Perfil:",
        "(clicca un profilo per aprirlo)": "(haz clic en un perfil para abrirlo)",
        "🧩 {n}": "🧩 {n}",
        "· {n} righe": "· {n} filas",
        "⚠ {name} (solo riferito)": "⚠ {name} (solo referenciado)",
        ...
        "⚠️ «{name}» è ancora selezionato in {count} parser ({names}): dopo l'eliminazione quei segnali verranno scartati (MAPPING_MISSING) finché non togli il profilo da quei parser.": "⚠️ «{name}» sigue seleccionado en {count} parsers ({names}): tras la eliminación esas señales se descartarán (MAPPING_MISSING) hasta que quites el perfil de esos parsers.",
        "⚠️ «{name}» è ancora selezionato in {count} parser ({names}): dopo l'eliminazione quei segnali verranno scartati (MARKET_MAPPING_MISSING) finché non togli il profilo da quei parser.": "⚠️ «{name}» sigue seleccionado en {count} parsers ({names}): tras la eliminación esas señales se descartarán (MARKET_MAPPING_MISSING) hasta que quites el perfil de esos parsers.",
        ...
        # Fail-fast P3-5 #76 — vedi blocco EN.
        "❌ Salvataggio config FALLITO: avvio annullato (al riavvio la pulizia del CSV userebbe la config vecchia su disco). Correggi l'errore segnalato sopra e riprova.": "❌ Guardado de config FALLIDO: inicio cancelado (al reiniciar la limpieza del CSV usaría la config antigua en disco). Corrige el error indicado arriba y reinténtalo.",
        ...
        "Griglia regole — 14 colonne CSV": "Cuadrícula de reglas — 14 columnas CSV",
        "Selezione:": "Selección:",
