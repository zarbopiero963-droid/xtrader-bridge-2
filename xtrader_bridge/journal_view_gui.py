...
from . import event_journal, i18n, journal_view, ui_theme
...
class JournalPanel(ctk.CTkFrame):
    ...
    def _build_ui(self):
        ...
        bar = ctk.CTkFrame(self, fg_color=ui_theme.SURFACE, corner_radius=ui_theme.RADIUS_CARD, border_width=1, border_color=ui_theme.BORDER)
        ...
        self._rows_frame = ctk.CTkScrollableFrame(self, height=400, fg_color=ui_theme.SURFACE, corner_radius=ui_theme.RADIUS_CARD, border_width=1, border_color=ui_theme.BORDER,
